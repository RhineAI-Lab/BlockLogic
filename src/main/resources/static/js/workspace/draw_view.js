...
const blockMenu = [
    ...
    {name:"信息处理",children:["摘要/加密","Base64","MD5"]},
...
const allBlockList = ["常用语句","循环","变量","函数","逻辑","数学","文本","列表","颜色","基于坐标操作","基于控件操作",
    ...
    "文件系统","多媒体","应用","调试工具","意图","插件","设置","电源管理","界面","常用功能","摘要/加密"];
const allBlockColor = ["#AAAAAA","#5AA45A","#A45A7F","#985AA4","#5A7FA4","#5A66A4","#5AA48B","#735AA4","#A4735A",
    ...
    "#b9993d","#d4285c","#d56331","#cc9999","#8e30be","#e5af00","#c68a16","#52a242","#3c2eaf","#AAAAAA","#88282a"];
