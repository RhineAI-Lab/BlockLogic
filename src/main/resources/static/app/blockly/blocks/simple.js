...
goog.provide('Blockly.Blocks.Simple');  // Deprecated
goog.provide('Blockly.Constants.Simple');
...
Blockly.defineBlocksWithJsonArray([
    {
        ...
        "output": "Boolean",
        "colour": colour,
        "tooltip": "向左/上滑动包含指定文本的控件，返回是否成功，第一项填-1则向左/上滑动全部",
        ...
        "output": "Boolean",
        "colour": colour,
        "tooltip": "向右/下滑动全部包含指定文本的控件，返回是否成功，第一项填-1则向右/下滑动全部",
