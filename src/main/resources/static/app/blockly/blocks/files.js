...
var colour = "#b9993d";
var baseHelpUrl = "https://pro.autojs.org/docs/#/zh-cn/files?id=";
...
Blockly.defineBlocksWithJsonArray([
    {
        ...
        "tooltip": "返回该文件夹是否为空文件夹。如果该路径并非文件夹，则直接返回false。"
    }, {
        "type": "files_join",
        ...
        "tooltip": '连接两个路径并返回，例如files.join("/sdcard/", "1.txt")返回"/sdcard/1.txt"。'
    }, {
        ...
        "tooltip": "创建一个文件或文件夹并返回是否创建成功。如果文件已经存在，则直接返回false。"
    }, {
        ...
        "tooltip": "创建一个文件或文件夹并返回是否创建成功。如果文件所在文件夹不存在，则先创建他所在的一系列文件夹。如果文件已经存在，则直接返回false。"
    }, {
        ...
        "tooltip": "确保该路径所在的文件夹存在。如果该路径所在文件夹不存在，则创建该文件夹。"
    }, {
        ...
        "tooltip": "读取该文本文件的所有内容并返回。如果文件不存在，则抛出FileNotFoundException。"
    }, {
        ...
        "tooltip": "读取该文件的所有内容并返回一个字节数组。如果文件不存在，则抛出FileNotFoundException。"
    }, {
        ...
        "tooltip": "删除文件夹，如果文件夹不为空，则删除该文件夹的所有内容再删除该文件夹，返回是否全部删除成功。"
    }, {
        ...
        "tooltip": '返回当前执行文件的"当前工作文件夹路径"。该路径指的是，如果脚本本身为脚本文件，则返回这个脚本文件所在目录；否则返回null获取其他设定路径。'
    }, {
        ...
        "tooltip": "列出该文件夹下的满足条件的文件和文件夹的名称的数组。如果不加filter参数，则返回所有文件和文件夹。"
    }
]);
