...
goog.provide("Blockly.Blocks.Device"); // Deprecated
goog.provide("Blockly.Constants.Device");
...
Blockly.defineBlocksWithJsonArray([
    {
        ...
        output: "Number",
        colour: colour,
        tooltip: "底层源代码管理用来表示此生成的内部值。例如，某次更改列表编号或git哈希。",
    ...
    },
    {
        ...
        output: "String",
        colour: colour,
        tooltip: "返回设备的Mac地址。该函数需要在有WLAN连接的情况下才能获取，否则会返回null。",
    ...
    },
    {
        ...
        message0: "取消设备保持唤醒状态",
        colour: colour,
        tooltip: "取消设备保持唤醒状态。用于取消device.keepScreenOn(), device.keepScreenDim()等函数设置的屏幕常亮。",
