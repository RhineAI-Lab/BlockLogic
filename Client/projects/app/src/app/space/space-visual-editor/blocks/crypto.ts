...
const colour = '#88282a';
const baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/crypto?id=';
...
Blockly.defineBlocksWithJsonArray([
  ...
  },
  {
    type: 'new_crypto_key',
    message0: '新建密钥 %1 ',
    args0: [{ type: 'input_value', name: 'MESSAGE', check: null }],
    output: 'Key',
    colour: colour,
  ...
  },
  {
    ...
    args0: [{ type: 'input_value', name: 'KEY', check: 'Key' }],
    output: 'Key',
    colour: colour,
    tooltip: '获取密钥的二进制数据。',
  ...
  },
  {
    ...
    args0: [{ type: 'input_value', name: 'KEY', check: 'KeyPair' }],
    output: 'Key',
    colour: colour,
    tooltip: '获取密钥对的公钥。',
    helpUrl: baseHelpUrl + 'keydata',
