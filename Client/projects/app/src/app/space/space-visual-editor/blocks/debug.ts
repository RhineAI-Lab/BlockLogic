...
const colour = '#cc9999';
const baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/debug?id=';
...
Blockly.defineBlocksWithJsonArray([
  {
    ...
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'HPROF', check: 'String' }],
    colour: colour,
    tooltip:
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'TRACE', check: 'String' }],
    colour: colour,
    tooltip: '',
