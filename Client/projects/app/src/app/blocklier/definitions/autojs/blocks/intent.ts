...
Blockly.defineBlocksWithJsonArray([
  {
    ...
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'INTENT', check: 'Object' }],
    colour: colour,
    tooltip:
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'START', check: 'Object' }],
    colour: colour,
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'SEND', check: 'Object' }],
    colour: colour,
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'SERVICE', check: 'Object' }],
    colour: colour,
    ...
    args0: [
      {
        ...
        name: 'CAST',
        options: [
          ['布局层次分析', 'inspect_layout_hierarchy'],
          ['布局范围', 'inspect_layout_bounds'],
        ],
      },
    ],
    previousStatement: null,
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'SHELL', check: 'Object' }],
    colour: colour,
  ...
  },
  {
    ...
    colour: colour,
    tooltip:
      '即使Uri格式错误，该函数也会返回一个Uri对象，但之后如果访问该对象的scheme, path等值可能因解析失败而返回null。',
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'FORFILE', check: 'String' }],
    colour: colour,
    tooltip:
      '在高版本Android上，由于系统限制直接在Uri暴露文件的绝对路径，因此返回的Uri会是诸如content://...的形式。',
  ...
  },
  {
    ...
    previousStatement: null,
    nextStatement: null,
    args0: [{ type: 'input_value', name: 'INSTALL', check: 'Object' }],
    colour: colour,
    tooltip:
      '如果设置了match选项 uninstalled_packages，则包括被删除但保留了数据的应用程序。获取安装的应用列表。返回值是ApplicationInfo对象的数组。 如果没有安装任何应用，则返回一个空数组。',
