...
const colour = '#cb863a';
const baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/storages?id=';
...
Blockly.defineBlocksWithJsonArray([
  ...
  },
  {
    ...
    nextStatement: null,
    tooltip:
      '把数据value保存到本地存储中。value可以是undefined以外的任意数据类型。如果value为undefined则抛出TypeError。',
  ...
  },
  {
    ...
    output: 'Boolean',
    tooltip:
      '返回该本地存储是否包含指定键值的数据。是则返回true，否则返回false。',
