...
(function (root, factory) {
  ...
  Blockly.Blocks.App = {};
  Blockly.Constants = {};
  Blockly.Constants.App = {};
  var colour = '#c6a000',
    baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/app?id=';
  ...
  Blockly.defineBlocksWithJsonArray([
    ...
    },
    {
      ...
      colour: colour,
      tooltip:
        '\u8bbe\u7f6e\u7a97\u53e3\u8fc7\u6ee4\u5668\uff0c\u51fd\u6570\u4f1a\u8f93\u5165\u4e00\u4e2a\u7a97\u53e3\uff0c\u9700\u8fd4\u56de\u5e03\u5c14\u503c\u8868\u793a\u662f\u5426\u4fdd\u7559',
  ...
  Blockly.Constants.Console = {};
  colour = '#0eaf9e';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/console?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'console_show',
      message0: '%1 \u63a7\u5236\u53f0 ',
    ...
    },
    {
      ...
      message0: '\u8bbe\u7f6e\u63a7\u5236\u53f0\u914d\u7f6e',
      message1: ' %1',
      args1: [{ type: 'input_statement', check: 'ConsoleConfig', name: 'DO' }],
      colour: colour,
      previousStatement: null,
      nextStatement: null,
      tooltip:
  ...
  Blockly.Blocks.Crypto = {};
  Blockly.Constants.Crypto = {};
  colour = '#88282a';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/crypto?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'crypto_digest',
  ...
  Blockly.Constants.Debug = {};
  colour = '#cc9999';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/debug?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: '$debug_dump_hprof',
      message0:
        '\u5c06\u6574\u4e2a\u811a\u672c\u8fdb\u7a0b\u7684\u5185\u5b58dump\u5230\u6587\u4ef6file\u4e2d %1 ',
      previousStatement: null,
      nextStatement: null,
    ...
    },
    {
      ...
      message0:
        '\u5c06\u6574\u4e2a\u811a\u672c\u8fdb\u7a0b\u7684\u5185\u5b58dump\u5230\u6587\u4ef6file\u4e2d\uff0c\u5e76\u81ea\u52a8\u538b\u7f29\u4e3azip\u6587\u4ef6',
      output: 'string',
      colour: colour,
      tooltip:
        '\u4f7f\u7528\u538b\u7f29\u7a0b\u5ea6\u6700\u9ad8\u7684\u538b\u7f29\u7b49\u7ea7\uff0c\u56e0\u6b64\u9700\u8981\u7684\u65f6\u95f4\u66f4\u4e45\uff0c\u4f46\u6587\u4ef6\u66f4\u5c0f\u3002',
  ...
  Blockly.Constants.Device = {};
  colour = '#3264e1';
  var colour2 = '#698a8a';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/device?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'device_width',
      message0: '\u8bbe\u5907\u5c4f\u5e55\u5206\u8fa8\u7387\u5bbd\u5ea6',
    ...
    },
    {
      ...
      message0: '\u8bbe\u7f6e\u5f53\u524d\u4eae\u5ea6\u6a21\u5f0f %1',
      args0: [
        { type: 'input_value', name: 'BRIGHTNESS_MODE', check: 'Number' },
      ],
      colour: colour,
      tooltip:
        '\u8bbe\u7f6e\u5f53\u524d\u4eae\u5ea6\u6a21\u5f0f\uff0c0\u4e3a\u624b\u52a8\uff0c1\u4e3a\u81ea\u52a8\u3002\n    \u6b64\u51fd\u6570\u9700\u8981"\u4fee\u6539\u7cfb\u7edf\u8bbe\u7f6e"\u7684\u6743\u9650\u3002\u5982\u679c\u6ca1\u6709\u8be5\u6743\u9650\uff0c\u4f1a\u629b\u51faSecurityException\u5e76\u8df3\u8f6c\u5230\u6743\u9650\u8bbe\u7f6e\u754c\u9762\u3002',
    ...
    },
    {
      ...
      colour: colour,
      tooltip:
        '\u53d6\u6d88\u8bbe\u5907\u4fdd\u6301\u5524\u9192\u72b6\u6001\u3002\u7528\u4e8e\u53d6\u6d88\u4fdd\u6301\u9707\u52a8\u7684\u6548\u679c\u3002',
      helpUrl: baseHelpUrl + 'devicecancelvibration',
      previousStatement: null,
      nextStatement: null,
    },
  ]);
  Blockly.Blocks.Dialogs = {};
  Blockly.Constants.Dialogs = {};
  colour = '#9abc86';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/dialogs?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'dialogs_alert',
  ...
  Blockly.Constants.Files = {};
  colour = '#b9993d';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/files?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'files_is_file',
      message0: '\u8def\u5f84 %1 \u662f\u5426\u662f\u6587\u4ef6',
    ...
    },
    {
      ...
      args0: [
        { type: 'input_value', name: 'PATH', check: 'String' },
        { type: 'input_value', name: 'VALUE', check: 'Array', align: 'RIGHT' },
      ],
      previousStatement: null,
      nextStatement: null,
      colour: colour,
      ...
      tooltip:
        '\u628abytes\u5199\u5165\u5230\u8be5\u6587\u4ef6\u4e2d\u3002\u5982\u679c\u6587\u4ef6\u5b58\u5728\u5219\u8986\u76d6\uff0c\u4e0d\u5b58\u5728\u5219\u521b\u5efa\u3002',
    },
    {
      type: 'files_append_path_text',
      message0:
        '\u4ee5 %3 \u7f16\u7801\u628a\u6587\u672c %2 \u8ffd\u52a0\u5230\u6587\u4ef6 %1 \u7684\u672b\u5c3e',
      args0: [
        { type: 'input_value', name: 'PATH', check: 'String' },
        { type: 'input_value', name: 'VALUE', check: 'String' },
        {
      ...
      tooltip:
        '\u628atext\u8ffd\u52a0\u5230\u8be5\u6587\u4ef6\u7684\u672b\u5c3e\u3002\u5982\u679c\u6587\u4ef6\u4e0d\u5b58\u5728\u5219\u521b\u5efa\u3002',
    },
    {
      type: 'files_append_bytes_path',
      message0:
        '\u4ee5 %3 \u7f16\u7801 \u8ffd\u52a0\u5b57\u8282\u6570\u7ec4 %2 \u5230\u6587\u4ef6 %1 \u672b\u5c3e',
      args0: [
        { type: 'input_value', name: 'PATH', check: 'String' },
    ...
    },
    {
      ...
      message0:
        '\u628a\u6587\u4ef6 %1 (\u4e0d\u5305\u542b\u6269\u5c55\u540d)\u91cd\u547d\u540d\u4e3a %2',
      args0: [
        { type: 'input_value', name: 'PATH', check: 'String', align: 'RIGHT' },
    ...
    },
    {
      type: 'files_list_dir',
      message0:
        '\u5217\u51fa\u6587\u4ef6\u5939\u8def\u5f84 %1 \u4e0b\u7684\u6ee1\u8db3\u6761\u4ef6 %2 \u7684\u6587\u4ef6\u548c\u6587\u4ef6\u5939\u7684\u540d\u79f0\u6570\u7ec4',
      args0: [
        { type: 'input_value', name: 'PATH', check: 'String', align: 'RIGHT' },
        {
          type: 'input_value',
  ...
  Blockly.Constants.Globals = {};
  colour = '#7476c6';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/globals?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'globals_sleep',
      message0: '\u7b49\u5f85 %1 \u6beb\u79d2',
    ...
    },
    {
      ...
      colour: colour,
      args0: [
        { type: 'field_checkbox', name: 'TYPE', checked: !1 },
  ...
  Blockly.Blocks.http = {};
  Blockly.Constants.Http = {};
  colour = '#339999';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/http?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'http_get',
      message0:
        'HTTP GET\u8bf7\u6c42 \u5730\u5740: %1 \u9009\u9879(\u53ef\u9009): %2 \u56de\u8c03(\u53ef\u9009): %3',
      args0: [
    ...
    },
    {
      type: 'http_post',
      message0:
        'HTTP POST\u8bf7\u6c42 \u5730\u5740: %1 \u6570\u636e: %2 \u9009\u9879(\u53ef\u9009): %3 \u56de\u8c03(\u53ef\u9009): %4',
      args0: [
        { type: 'input_value', name: 'URL', check: 'String' },
        {
          type: 'input_value',
    ...
    },
    {
      type: 'http_request',
      message0:
        'HTTP REQUEST\u8bf7\u6c42 \u5730\u5740: %1 \u9009\u9879(\u53ef\u9009): %2 \u56de\u8c03(\u53ef\u9009): %3',
      args0: [
        { type: 'input_value', name: 'URL', check: 'String' },
        {
          type: 'input_value',
    ...
    },
    {
      ...
      message1: ' %1',
      args1: [
        { type: 'input_statement', check: 'HttpOption', name: 'OPTIONS' },
      ],
      colour: colour,
      output: 'HttpOptions',
      tooltip: '\u914d\u7f6e\u8bf7\u6c42\u9009\u9879',
    ...
    },
    {
      ...
      message0:
        '\u83b7\u53d6\u8bf7\u6c42\u8fd4\u56de\u4fe1\u606f \u8bf7\u6c42: %1 \u4fe1\u606f: %2',
      args0: [
        { type: 'input_value', name: 'RES', check: 'String' },
        {
          type: 'field_dropdown',
          name: 'VALUE',
          options: [
  ...
  Blockly.Blocks.Intent = {};
  Blockly.Constants.Intent = {};
  colour = '#8e30be';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/app?id=';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Blocks.Plugins = {};
  Blockly.Constants.Plugins = {};
  colour = '#e5af00';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/app?id=';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Blocks.Powermanager = {};
  Blockly.Constants.Powermanager = {};
  colour = '#52a242';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/app?id=';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Blocks.Automator = {};
  Blockly.Constants.Automator = {};
  colour = '#e6645c';
  baseHelpUrl =
    'https://pro.autojs.org/docs/#/zh-cn/coordinatesBasedAutomation?id=';
  Blockly.defineBlocksWithJsonArray([
  ...
  Blockly.Blocks.Simple = {};
  Blockly.Constants.Simple = {};
  colour = '#90b01f';
  baseHelpUrl =
    'https://pro.autojs.org/docs/#/zh-cn/widgetsBasedAutomation?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      ...
      colour: colour,
      tooltip:
        '\u70b9\u51fb\u5305\u542b\u6307\u5b9a\u6587\u672c\u7684\u63a7\u4ef6\uff0c\u8fd4\u56de\u662f\u5426\u6210\u529f\uff0c\u7b2c\u4e00\u9879\u586b-1\u5219\u70b9\u51fb\u5168\u90e8',
    ...
    },
    {
      ...
      colour: colour,
      tooltip:
        '\u8ffd\u52a0\u6587\u672c\u6846\u6587\u672c\uff0c\u8fd4\u56de\u662f\u5426\u6210\u529f\uff0c\u7b2c\u4e00\u9879\u586b-1\u5219\u64cd\u4f5c\u5168\u90e8',
      helpUrl: baseHelpUrl + 'inputi-text',
    },
  ]);
  Blockly.Blocks.Storages = {};
  Blockly.Constants.Storages = {};
  colour = '#cb863a';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/storages?id=';
  Blockly.defineBlocksWithJsonArray([
    {
    ...
    },
    {
      ...
      message0:
        '\u672c\u5730\u50a8\u5b58 - \u5220\u9664\u6240\u6709  \u5bf9\u8c61 %1  ',
      args0: [{ type: 'input_value', name: 'STORAGE', check: 'Object' }],
      colour: colour,
      previousStatement: null,
      nextStatement: null,
      tooltip:
  ...
  Blockly.Blocks.Ui = {};
  Blockly.Constants.Ui = {};
  colour = '#3c2eaf';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/ui?id=';
  Blockly.defineBlocksWithJsonArray([
    {
      type: 'ui_layout',
      message0: '\u663e\u793a\u5e03\u5c40 %1',
      args0: [{ type: 'input_value', name: 'UI_XML', check: 'UiXml' }],
      previousStatement: null,
      nextStatement: null,
      colour: colour,
      tooltip: '',
    ...
    },
    {
      type: 'ui_layout_file',
      message0: '\u663e\u793a\u5e03\u5c40\u6587\u4ef6 %1',
      args0: [{ type: 'input_value', name: 'FILE_PATH', check: 'String' }],
      previousStatement: null,
      nextStatement: null,
      colour: colour,
      tooltip: '',
    ...
    },
    {
      ...
      colour: colour,
      tooltip:
        '\u6e32\u67d3XML\u6210\u89c6\u56fe\u3002\u5982\u679c\u8be5View\u5c06\u4f5c\u4e3a\u67d0\u4e2aView\u7684\u5b50View\uff0c\u6211\u4eec\u5efa\u8bae\u4f20\u5165parent\u53c2\u6570\uff0c\u8fd9\u6837\u5728\u6e32\u67d3\u65f6\u4f9d\u8d56\u4e8e\u7236\u89c6\u56fe\u7684\u4e00\u4e9b\u5e03\u5c40\u5c5e\u6027\u80fd\u591f\u6b63\u786e\u5e94\u7528\u3002',
    ...
    },
    {
      ...
      colour: colour,
      tooltip:
        '\u542f\u7528\u4f7f\u7528Android\u7684\u5e03\u5c40(layout)\u3001\u7ed8\u56fe(drawable)\u3001\u52a8\u753b(anim)\u3001\u6837\u5f0f(style)\u7b49\u8d44\u6e90\u7684\u7279\u6027\u3002\u542f\u7528\u8be5\u7279\u6027\u540e\uff0c\u9700\u5728project.json\u4e2d\u8fdb\u884c\u914d\u7f6e\u3002',
      helpUrl: baseHelpUrl + 'uiuseandroidresources',
    },
    {
      type: 'ui_set_content_view',
      message0: '\u8bbe\u7f6e\u89c6\u56fe\u4e3a\u5f53\u524d\u89c6\u56fe %1',
      args0: [{ type: 'input_value', name: 'UI_VIEW', check: 'UiView' }],
      previousStatement: null,
      nextStatement: null,
      colour: colour,
      tooltip:
  ...
  Blockly.Blocks.UiBtn = {};
  Blockly.Constants.UiBtn = {};
  colour = '#3c2eaf';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/ui?id=';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Blocks.UiText = {};
  Blockly.Constants.UiText = {};
  colour = '#3c2eaf';
  baseHelpUrl = 'https://pro.autojs.org/docs/#/zh-cn/ui?id=';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Blocks.VarFunction = {};
  Blockly.Constants.VarFunction = {};
  colour = '#0eaf9e';
  Blockly.defineBlocksWithJsonArray([
    {
  ...
  Blockly.Constants.VarFunction.VAR_FUNCTION_JOIN_MUTATOR_MIXIN = {
    ...
    decompose: function (a) {
      var b = a.newBlock('inputs_join_container');
      b.initSvg();
      for (
        var c = b.getInput('STACK').connection, d = 0;
        d < this.itemCount_;
        ...
        var e = a.newBlock('inputs_join_item');
        e.initSvg();
        c.connect(e.previousConnection);
        c = e.nextConnection;
      }
    ...
    updateShape_: function () {
      this.getInput('STAT') && this.removeInput('STAT');
      this.itemCount_ && this.getInput('EMPTY')
        ? this.removeInput('EMPTY')
        : this.itemCount_ ||
          this.getInput('EMPTY') ||
      ...
      for (var a = 0; a < this.itemCount_; a++)
        this.getInput('ADD' + a) ||
          this.appendValueInput('ADD' + a).setAlign(Blockly.ALIGN_RIGHT);
      for (; this.getInput('ADD' + a); ) this.removeInput('ADD' + a), a++;
  ...
  Blockly.Constants.Widget.WIDGET_SELECTORS_JOIN_MUTATOR_MIXIN = {
    ...
    decompose: function (a) {
      var b = a.newBlock('widget_selectors_join_container');
      b.initSvg();
      for (
        var c = b.getInput('STACK').connection, d = 0;
        d < this.itemCount_;
        ...
        var e = a.newBlock('widget_selectors_join_item');
        e.initSvg();
        c.connect(e.previousConnection);
        c = e.nextConnection;
      }
