...
(function (root, factory) {
  ...
  Blockly.Events.Abstract.prototype.onRun = function (a) {};
  ...
  Blockly.Events.Change.prototype.onRun = function (a) {
  ...
  Blockly.Events.Create.prototype.onRun = function (a) {
  ...
  Blockly.Events.Delete.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_();
    if (a) {
      a = 0;
      for (var c; (c = this.ids[a]); a++) {
  ...
  Blockly.Events.Move.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_(),
  ...
  Blockly.Events.VarCreate.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_();
    a
  ...
  Blockly.Events.VarDelete.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_();
    a
      ? b.deleteVariableById(this.varId)
      : b.createVariable(this.varName, this.varType, this.varId);
  ...
  Blockly.Events.VarRename.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_();
    a
  ...
  Blockly.WorkspaceDragSurfaceSvg.prototype.setContentsAndShow = function (
    ...
    isNaN(d) ||
      isNaN(e) ||
      (this.SVG_.setAttribute('width', d), this.SVG_.setAttribute('height', e));
  ...
  Blockly.Events.CommentChange.prototype.onRun = function (a) {
  ...
  Blockly.Events.CommentCreate.prototype.onRun = function (a) {
  ...
  Blockly.Events.CommentDelete.prototype.onRun = function (a) {
    Blockly.Events.CommentCreateDeleteHelper(this, !a);
  };
  ...
  Blockly.Events.CommentMove.prototype.onRun = function (a) {
    var b = this.getEventWorkspace_().getCommentById(this.commentId);
    if (b) {
  ...
  Blockly.Names.prototype.getName = function (a, b) {
    ...
    b =
      ...
      b == Blockly.Names.DEVELOPER_VARIABLE_TYPE
        ...
        : '';
    if (c in this.db_) return b + this.db_[c];
    this.db_[c] = a.substr(b.length);
    return a;
  };
  ...
  Blockly.Generator.prototype.valueToCode = function (a, b, c, d) {
    d = d || !1;
    if (isNaN(c))
      throw TypeError('Expecting valid order from block: ' + a.type);
    var e = a.getInputTargetBlock(b);
    if (!e) return '';
    b = this.blockToCode(e);
    if ('' === b) return '';
    if (!Array.isArray(b))
      throw TypeError('Expecting tuple from value block: ' + e.type);
    a = b[0];
    b = b[1];
    if (isNaN(b))
      throw TypeError('Expecting valid order from value block: ' + e.type);
    if (!a) return '';
    if (d) return a;
    d = !1;
    e = Math.floor(c);
  ...
  Blockly.Generator.prototype.setRunMode_ = function (a) {
    this.definitions_.RunMode = '"' + a + '";';
  };
  ...
  Blockly.blockRendering.ConstantProvider.prototype.makeNotch = function () {
    function a(g) {
      return Blockly.utils.svgPaths.line([
        ...
        Blockly.utils.svgPaths.point(7 * g, 0),
        Blockly.utils.svgPaths.point(g * d, -c),
      ]);
    }
